/******************************************************************
Change Script 0.0.16
Date: 10/30/15

    1. New spatial source
    2. Remove underscore from current spatial sources
    3. Parcels created from survey are classifiied as survey coordinates

******************************************************************/

INSERT INTO spatial_source (type) VALUES ('survey coordinates');
UPDATE spatial_source SET type = 'survey sketch' WHERE type = 'survey_sketch';
UPDATE spatial_source SET type = 'recreational gps' WHERE type = 'recreational_gps';
UPDATE spatial_source SET type = 'survey grade gps' WHERE type = 'survey_grade_gps';
